...
**The project is currently based on PhenoTips 1.3-milestone-5**. Because of its modular nature, it can be made to work with newer versions of PhenoTips without substantial effort.
