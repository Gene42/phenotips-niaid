...
/**
 * Registers {@link org.phenotips.metabolites.TestReport} with Hibernate.
 *
 * @version $Id$
 * @since 1.0M10
 */
@Component
@Named("metabolite-test-report-orm-registration")
@Singleton
public class ORMRegistrationHandler implements EventListener
{
    ...
    {
        return "metabolite-test-report-orm-registration";
    }
    ...
    public void onEvent(Event event, Object source, Object data)
    {
        ...
        configuration.addAnnotatedClass(TestReport.class);
    }
}
