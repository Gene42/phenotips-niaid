...
public class XWikiAuthServiceImpl extends AbstractXWikiAuthService
{
    ...
    public Principal authenticate(String username, String password, XWikiContext context) throws XWikiException
    {
        ...
        if (context != null) {
            ...
            DocumentReference userReference = this.currentDocumentReferenceResolver.resolve(cannonicalUsername);
            if (!context.getWiki().exists(userReference, context)) {
                userReference =
                    new DocumentReference(username, new SpaceReference("XWiki",
    ...
    protected String findUser(String username, XWikiContext context) throws XWikiException
    {
        ...
        if (context.getWiki().exists(new DocumentReference(context.getDatabase(), "XWiki", username), context)) {
            user = new DocumentReference(context.getDatabase(), "XWiki", username).toString();
        } else {
