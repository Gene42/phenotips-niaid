...
public class DefaultResponseRowHandler implements ResponseRowHandler
{
    ...
    private ResponseColumnHandler columnHandler = new ResponseColumnHandler();
    ...
    */
     ...
     */
    public JSONObject getRow(XWikiDocument doc, XWikiContext context, List<TableColumn> cols) throws XWikiException
    {
        if (doc == null) {
            return null;
        }
        ...
        for (TableColumn col : cols) {
            this.columnHandler.addColumn(row, col, doc, context, this.componentManager);
        }
    ...
    /**
     * Setter for componentManager.
     *
     * @param componentManager the value to set
     * @return this object
     */
    public DefaultResponseRowHandler setComponentManager(ComponentManager componentManager)
    {
